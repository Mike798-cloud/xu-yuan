(function(){
  ...
  const configs={
    ...
    oa:{test:'site-oa',after:'.oa-head',kind:'records',lines:['MLU-ARC / READ ONLY　INDEX 1842 RECORDS','REC_QUERY READY　PUBLIC FIELDS ONLY','BACKUP NODE 02　LAST VERIFY 2017-04-20','STATIC INVENTORY　1 UNASSIGNED OBJECT'],cards:[['DOC-143','行政楼','PAPER'],['LOG-812','网络中心','DEVICE'],['IDX-044','东区','ROUTE']]},
